...
import { Box, Button, Divider, Grid, Link, SvgIcon } from '@mui/material';
  ...
  return (
    <Grid>
      ...
      <Grid container className={classes.contentContainer} pt={1}>
        ...
        <Grid item xs={12} className={classes.argeementBlock} direction={'column'}>
          <Grid item xs={12}>
