...
import { colors, defaultThemePalette, themeColors } from './default-theme.palette';
...
export const DefaultTheme = createTheme({
  ...
  components: {
    ...
    MuiButton: {
      ...
      styleOverrides: {
        root: {
          ...fonts.button_label.button_label_1,
          backgroundColor: defaultThemePalette.surfaces.$surf_bg,
          color: defaultThemePalette.on.$on_prime,
          minWidth: spacings.$unit * 20,
          textTransform: 'none',
          textAlign: 'center',
          paddingLeft: spacings.$unit * 4,
          paddingRight: spacings.$unit * 4,
          borderRadius: spacings.$unit,
        },
        containedError: {
          backgroundColor: defaultThemePalette.surfaces.$surf_error,
        },
        containedSuccess: {
          backgroundColor: defaultThemePalette.surfaces.$surf_success,
        },
        // endIcon: {
        //   marginRight: -8
        // },
